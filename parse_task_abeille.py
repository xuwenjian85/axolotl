...
with tempfile.TemporaryDirectory() as tmp_dir:
    ...
    # OUTSINGLE
    # ABEILLE
    # GPU < 40s/?C/10G) + CPU (30min/1C/10G)
    script = '/mnt/disk7t/xwj/axolotl_rev/script/abeille.sh'
    outscore = task_config.loc[simu,'ABEILLE']
    # gpu = 1
    # os.system(f'bash {script} {cts_tmpfile} {gpu} {outscore}')
    os.system(f'bash {script} {cts_tmpfile} {outscore}')
    postprocess('abeille', outscore, cts_tmpfile)
